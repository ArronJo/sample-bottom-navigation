package com.snc.sample.bottom_navigation.ui.fragment.popup;
...
import com.snc.sample.bottom_navigation.databinding.FragmentPopupBinding;
...
public class PopupFragment extends BaseFragment {
    ...
    private View binding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        FragmentPopupBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_popup, container, false);
